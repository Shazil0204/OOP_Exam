...
namespace Apartment_renovation.Model.Classes
{
    ...
    {
        #region Constructor
        internal VindbjergWindow(string color, string guarantee, string WindowsType, bool isFrostedGlass, ushort mainDoorPrice, ushort backDoorPrice, bool isbackDoorBD60, bool isbackDoorBD40)
